        ...
        >
          <div className="relative top-[10%] -left-[10vh]">
            ...
            <button 
              ...
              className="mt-6 px-8 py-3 text-base font-semibold text-white bg-[#354F52] rounded-md shadow-lg transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-xl active:translate-y-0 active:shadow-md"
            >
              Get started
            </button>
          </div>
